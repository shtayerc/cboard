...
void piece_unload();
void piece_draw(WindowData* data, int file, int rank, SDL_Texture* texture);
...
void chessboard_focus_present(WindowData* data, Square src, Square dst, Piece prom_piece);
void chessboard_vs_next(WindowData* data, int* vs_index);
void chessboard_move_do(WindowData* data, Square src, Square dst, Piece prom_piece, Status status);
